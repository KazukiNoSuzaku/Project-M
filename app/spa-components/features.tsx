...
export default function Features() {
  ...
  return(
    ...
    <main >
            <div className="flex relative lg:overflow-visible w-full flex-wrap justify-between bg-gradient-to-r from-green-700 to-olive-500 items-center ">
                  ...
                  <div className="flex pt-20 md:pt-10 relative z-20 flex-col gap-6 w-full lg:w-1/2 xl:mt-20 block">
                      <div className="text-center leading-8 md:leading-10 md:text-left">
                          <div className="inline-block">
                              <h1 className="tracking-tight text-white inline font-semibold text-[2.1rem] lg:text-5xl">About us&nbsp;</h1>
                          </div>
